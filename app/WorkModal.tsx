...
export function WorkModal({
    ...
    >
        ...
        {/* Navigation buttons */}
        {prevLink && <div className="absolute top-0 bottom-0 left-4 flex items-center justify-between">
            <Link
                href={prevLink}
        ...
        {nextLink && <div className="absolute top-0 bottom-0 right-4 flex items-center justify-between">
            <Link
                href={nextLink}
                className="p-2 m-4 bg-black bg-opacity-30 hover:bg-opacity-50 text-white rounded-full"
